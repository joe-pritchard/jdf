...
class JMFEntryFailedListener
{
    ...
    /**
     * JMFEntryFailedListener constructor. Initialise the callback class if provided
     */
     ...
     *
     * @param JMFEntryFailed $event
     */
    public function handle(JMFEntryFailed $event): void
    {
